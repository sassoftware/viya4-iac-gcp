...
| server_version | The version of the  PostgreSQL server instance | string | "13" | Refer to the [Viya 4 Deployment Guide](https://go.documentation.sas.com/doc/en/sasadmincdc/default/itopssr/p05lfgkwib3zxbn1t6nyihexp12n.htm?fromDefault=#p1wq8ouke3c6ixn1la636df9oa1u) to see a list of supported PostgreSQL version |
