...
2. Manifest Scanner (google provider CHANGELOG deprecation check)
...
def run_manifest_scanner(repo_root: str) -> Optional[Dict[str, Any]]:
    """
    Run the manifest-based google provider CHANGELOG scanner.
    ...
    print("\n" + "-" * 70)
    print("  📋 Running Manifest Scanner (google provider CHANGELOG)")
    print("-" * 70 + "\n")
    ...
    print("  → Checking Google provider CHANGELOG...")
    try:
        result = subprocess.run(
...
def generate_integrated_html_report(
    ...
    if manifest_report:
        ...
        <section class="manifest-section">
            <h2>📋 Google Provider CHANGELOG Analysis</h2>
            ...
            <p class="manifest-ref">
                <a href="https://github.com/hashicorp/terraform-provider-google/blob/main/CHANGELOG.md" target="_blank">
                    📚 View Full CHANGELOG
                </a>
            </p>
        </section>
...
def main():
    ...
    # =========================================================================
    # Scanner 2: Manifest Scanner (Google Provider CHANGELOG)
    # =========================================================================
...
""")
    ...
    if manifest_report:
        ...
        print(f"""Manifest Scanner (Google provider {curr_ver} → {lat_ver}):
