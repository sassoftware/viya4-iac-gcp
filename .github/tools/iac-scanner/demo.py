...
def main():
    ...
    target_repo = os.path.join(os.path.dirname(script_dir), "viya4-iac-gcp")
    
    # Check if target exists
    if not os.path.exists(target_repo):
        # Try relative path
        target_repo = os.path.join(script_dir, "..", "viya4-iac-gcp")
    ...
    if not os.path.exists(target_repo):
        print("Error: Could not find viya4-iac-gcp repository")
