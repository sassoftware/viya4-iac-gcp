...
def get_latest_version():
    content = fetch_url(REGISTRY_API, "Terraform Registry (latest google provider version)")
...
def main():
    parser = argparse.ArgumentParser(
        description="Check google/google-beta Terraform resources for deprecations"
    )
    ...
    print(f"  Latest google provider version: {latest_version}")
    print(f"  Your google provider version  : {old_version}")
    ...
    report = {
        ...
        "affected_resources": [],
        "references": {
            "terraform_registry": f"https://registry.terraform.io/providers/hashicorp/google/{latest_version}/docs",
